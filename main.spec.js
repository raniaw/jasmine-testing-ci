describe('main.js', function () {
  describe('calculate()', function () {
    ...
    it('calls add', function () {
      ...
      expect(spy).toHaveBeenCalledWith(3); // '3+4' -> 3
      expect(spy).toHaveBeenCalledWith(4); // '3+4' -> 4
    });
    ...
    it('calls subtract', function () {
      ...
      expect(spy).toHaveBeenCalledWith(7); // '3-7' -> nimber b is 7
    });
    ...
    it('calls multiply', function () {
      ...
      expect(spy).toHaveBeenCalled();
      expect(spy).not.toHaveBeenCalledWith(3); // '3*8' -> number b is 8 not 3
      expect(spy).toHaveBeenCalledWith(8); // '3*8' -> 8
    });
    ...
    it('calls divide', function () {
      ...
      expect(spy).toHaveBeenCalled();
      expect(spy).not.toHaveBeenCalledWith(3); // '3/2' -> number b is 2 not 3
      expect(spy).toHaveBeenCalledWith(2); // '3/2' -> 2
    });
    ...
    it('calls updateResult (example using and.callThrough)', function () {
      ...
      expect(window.updateResult).toHaveBeenCalled();
      expect(window.updateResult).toHaveBeenCalledWith(25); // 5*5=25
    });
